...
/* #define BACKGROUND_TINT_COLOR  "red" */
...
/* #define PROGRAM_ICON           "../misc/evilvte.svg" */
...
#define HOTKEY_MIMIC_SCROLL_DOWN     CTRL GDK_Page_Down
...
#define    HOTKEY_TAB_REMOVE            CTRL GDK_d
